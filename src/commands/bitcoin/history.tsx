/**
 * Bitcoin Transaction History command
 */
...
export function BitcoinHistory({ address, network, json, limit }: BitcoinHistoryProps) {
  ...
  if (loading) {
    return (
      <Box>
        <Text>Fetching Bitcoin transaction history...</Text>
      </Box>
    );
  }
            ...
            >
              ...
              {tx.amount && (
                <Box>
                  ...
                  <Text color="green">{tx.amount} BTC</Text>
                </Box>
              )}
              ...
              {tx.fee && (
                <Box>
                  ...
                  <Text color="red">{tx.fee} BTC</Text>
                </Box>
              )}
            </Box>
          ))}
