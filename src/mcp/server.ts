  ...
  server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    try {
      ...
      switch (name) {
        ...
        case 'wallet_restore': {
          const { name: walletName, mnemonic, password } = args as {
            name: string;
            mnemonic: string;
            password: string;
          };
        ...
        case 'wallet_history': {
          const { address, limit = 10, page = 1, network = 'mainnet' } = args as {
            address: string;
            limit?: number;
            page?: number;
            network?: string;
        ...
        case 'wallet_send': {
          const { to, amount, wallet, network = 'mainnet', asset } = args as {
            to: string;
            amount: string;
            wallet?: string;
            network?: string;
        ...
        case 'stake_delegate': {
          const { poolId, wallet, network = 'mainnet' } = args as {
            poolId: string;
            wallet?: string;
            network?: string;
          };
        ...
        case 'swap_quote': {
          const { from, to, amount, network = 'mainnet' } = args as {
            from: string;
            to: string;
            amount: string;
            network?: string;
        ...
        case 'swap_execute': {
          const { from, to, amount, slippage, wallet, network = 'mainnet' } = args as {
            from: string;
            to: string;
            amount: string;
            slippage?: number;
        ...
        case 'mint_nft': {
          const { image, name: nftName, to, description } = args as {
            image: string;
            name: string;
            to: string;
            description?: string;
